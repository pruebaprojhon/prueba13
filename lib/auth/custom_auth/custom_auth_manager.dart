...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    infyVcardAuthUserSubject.add(
      InfyVcardAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<InfyVcardAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  InfyVcardAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = InfyVcardAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    infyVcardAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
